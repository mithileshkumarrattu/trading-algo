...
MIN_DISCOVERY_QUOTE_COVERAGE_PCT = 95.0
DISCOVERY_FAILURE_RETRY_SEC = 60
QUOTE_BATCH_GAP_SEC = 2.5
QUOTE_RATE_LIMIT_COOLDOWN_SEC = 180
STARTUP_REQUIRED_CONFIG = (
	"ENTRY_TIMEFRAME", "SOURCE_CANDLE_TIMEFRAME", "ALPHA_TIMEFRAME",
	"JP_TIMEFRAME", "PATTERN_TIMEFRAME", "MIN_PRICE", "MIN_PCT_MOVE",
	"MAX_PCT_MOVE", "DISCOVERY_QUOTE_CHUNK", "MIN_DISCOVERY_QUOTE_COVERAGE_PCT",
)
