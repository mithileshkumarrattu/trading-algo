...
TOP_N_GAINERS = 10
TOP_N_LOSERS = 10
INITIAL_DISCOVERY_DELAY_SEC = 45
WS_TOP_MOVERS_PER_SIDE = 10
MIN_WEBSOCKET_COVERAGE_PCT = 90.0
MAX_LIVEFEED_AGE_SEC = 15
LOCAL_DISCOVERY_REFRESH_SEC = 5
DISCOVERY_QUOTE_CHUNK = 45
DISCOVERY_FULL_SCAN_INTERVAL_SEC = 300
FINAL_UNIVERSE_LOCK_TIME = (14, 45, 0)
SCAN_GROUP_SIZE_PER_SIDE = 10
QUOTE_BATCH_GAP_SEC = 2.5
QUOTE_RATE_LIMIT_COOLDOWN_SEC = 300
...
JP_TIMEFRAME = 3
JP_REQUIRE_MARKET_REGIME = True
JP_OPENING_CONDITION_REQUIRED = True
JP_CONTEXT_BARS = 3
JP_SMMA_LENGTH = 10
...
JP_TOP_N_PER_SIDE = 20
JP_MAX_SIGNALS_PER_SYMBOL_PER_DAY = 1
JP_MAX_CONFIRMATION_PATTERN_BARS = 1
SEND_TELEGRAM_ON_JP_SETUP = True

ALPHA_ALLOW_SELL = False
ALPHA_REQUIRE_MARKET_BULLISH = True
ALPHA_REQUIRE_CLOSE_CONFIRMATION = True
ALPHA_CONFIRMATION_PATTERN_BARS = 2
ALPHA_MIN_TREND_CANDLES = 3
ALPHA_MIN_TREND_BODY_RATIO = 0.55
ALPHA_MIN_TREND_BODY_TO_WICK_RATIO = 1.0
ALPHA_MIN_TREND_VOLUME_RATIO = 0.90
ALPHA_MAX_ALPHA_VOLUME_RATIO = 1.50
ALPHA_MIN_ALPHA_BODY_RATIO = 0.35
ALPHA_MIN_ALPHA_BODY_TO_WICK_RATIO = 1.0
ALPHA_MAX_ENTRY_PATTERN_BARS = 2
ALPHA_MAX_ENTRY_MINUTES = 8
ALPHA_ALLOW_OPENING_MOMENTUM_EXCEPTION = True
ALPHA_OPENING_EXCEPTION_END = (10, 0, 0)
ALPHA_OPENING_MIN_VOLUME_RATIO = 1.20
ALPHA_MAX_DISTANCE_FROM_SMMA_PCT = 1.25
ALPHA_MAX_ENTRY_PATTERN_BARS = 2
ALPHA_MAX_ENTRY_MINUTES = 8
ALPHA_ENTRY_WICK_ONLY = False
